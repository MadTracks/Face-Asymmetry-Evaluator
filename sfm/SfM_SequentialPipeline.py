...
OPENMVG_SFM_BIN = "/home/madtracks/Desktop/openmvg/openMVG_Build/Linux-x86_64-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/madtracks/Desktop/openmvg/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-k", "819.31819931; 0.; 323.6771069; 0.; 815.82745283; 230.70272958; 0.; 0.; 1.;","-d", camera_file_params] )
pIntrisics.wait()

print ("2. Compute features")
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures"),  "-i", matches_dir+"/sfm_data.json","-p","ULTRA", "-o", matches_dir, "-m", "AKAZE_FLOAT"] )
pFeatures.wait()
...
print ("8. Create JSON")
pRecons = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ConvertSfM_DataFormat"),  "-i", reconstruction_dir+"/sfm_data.bin", "-o", os.path.join(reconstruction_dir,"sfm2_data.json")] )
pRecons.wait()
